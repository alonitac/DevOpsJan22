...
class TestJsonConfigsMerge(unittest.TestCase):
    ...
    def test_jason_files(self):
        ...
        self.assertEqual(questions.json_configs_merge('jpg.json', 'student.json'), {"id": "0001", "type": "donut", "name": "Cake", "image": {"url": "images/0001.jpg", "width": 200, "height": 200}, "thumbnail": {"url": "images/thumbnails/0001.jpg", "width": 32, "height": 32}, "student": [{"id": "01", "name": "Tom", "lastname": "Price"}, {"id": "02", "name": "Nick", "lastname": "Thameson"}]})
...
class TestStrCompression(unittest.TestCase):
    ...
    def test_sample(self):
            ...
            self.assertEqual(questions.str_compression('AAABCCADDDDD'), ['A', 3, 'B', 1, 'C', 2, 'A' ,1, 'D', 5])
            # your code here
            pass
