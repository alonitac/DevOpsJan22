...
[comment]: <> (2. Create a branch `aws_answers/<your-alias>` from `main` &#40;while `<your-alias>` is your unique nickname&#41;. If this branch is already exist, pull branch `main` to get an up-to-date version, then merge `main` into your branch.)

[comment]: <> (3. Checkout your branch `answers/<your-alias>`.)

[comment]: <> (4. In each question set, bold the correct answer &#40;ctrl+b or double asterisk - \*\*text\*\*&#41;.)

[comment]: <> (5. Commit and push.)

[comment]: <> (6. Wait for statistics to be shown here &#40;page refresh is needed&#41;.)
