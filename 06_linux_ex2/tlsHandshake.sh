...
# FIXME The idea was automate the script, not using manual copy-paste steps at all -20
...
# FIXME missing validation that encrypted sample message is equal to original one -10
